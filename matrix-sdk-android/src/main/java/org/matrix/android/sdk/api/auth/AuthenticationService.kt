...
interface AuthenticationService {
     ...
     */
    suspend fun getLoginFlow(homeServerConnectionConfig: HomeServerConnectionConfig,api:String): LoginFlowResult

    /**
     * Request the supported login flows for the corresponding sessionId.
     */
    suspend fun getLoginFlowOfSession(sessionId: String,api:String): LoginFlowResult
