...
sealed class LoginViewEvents : VectorViewEvents {
    ...
    data class OnLoginModeSelected(val signMode: SignMode):LoginViewEvents()
    ...
    object OnEnrollingNewClient : LoginViewEvents()
    object OnEnrollingNewClientCompleted: LoginViewEvents()
    ...
    object ResetPasswordCheckUserExist:LoginViewEvents()
    object ResetPasswordSendEmail: LoginViewEvents()
    object GetClinicsSuccess:LoginViewEvents()
}
