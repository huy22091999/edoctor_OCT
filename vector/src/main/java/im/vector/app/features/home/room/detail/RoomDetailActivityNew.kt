...
class RoomDetailActivityNew :
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val roomDetailArgs: RoomDetailArgs = RoomDetailArgs(roomId = "1111111")
    ...
    companion object {
        ...
        fun newIntent(context: Context, roomDetailArgs: RoomDetailArgs): Intent {
            return Intent(context, RoomDetailActivityNew::class.java).apply {
