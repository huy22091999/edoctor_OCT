...
/*        isForSessionRecovery = state.deviceId?.isNotBlank() == true
    ...
    private fun launchWebView(state: LoginViewState) {
        val url = loginViewModel.getFallbackUrl(state.signMode == SignMode.SignIn, state.deviceId)
            ?: return

        //views.loginWebWebView.loadUrl("https://teleprep.org/")
            ...
            override fun shouldOverrideUrlLoading(view: WebView, url: String?): Boolean {
                ...
                if (url.startsWith("js:")) {
                    ...
                    try {
                        ...
                        val adapter =
                            MoshiProvider.providesMoshi().adapter(JavascriptResponse::class.java)
