        ...
        override fun create(viewModelContext: ViewModelContext, state: HomeDetailViewState): HomeDetailViewModel? {
            ...
            return when (viewModelContext) {
                is FragmentViewModelContext -> {
                    val fragment: HomeDetailFragment = viewModelContext.fragment()
                    fragment.homeDetailViewModelFactory.create(state)
                }

                is ActivityViewModelContext -> {
                    val factory = viewModelContext.activity as? Factory
