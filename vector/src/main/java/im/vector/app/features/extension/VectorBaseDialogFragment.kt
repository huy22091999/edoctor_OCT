...
import im.vector.app.core.platform.*
...
abstract class VectorBaseDialogFragment<VB : ViewBinding> : BaseMvRxDialogFragment(), HasScreenInjector {
    ...
    override fun onAttach(context: Context) {
        screenComponent =
            DaggerScreenComponent.factory().create(vectorBaseActivity.getVectorComponent(), vectorBaseActivity)
