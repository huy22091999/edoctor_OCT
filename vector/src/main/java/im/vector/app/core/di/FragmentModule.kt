...
import im.vector.app.ext.home.GlobitsHomeFragment
import im.vector.app.ext.registration.*
import im.vector.app.ext.test.TestCallFragment
...
import im.vector.app.features.crypto.recover.*
...
import im.vector.app.features.settings.*
...
import im.vector.app.features.settings.devtools.*
...
interface FragmentModule {
    ...
    @Binds
    @IntoMap
    @FragmentKey(TestCallFragment::class)
    fun bindTestCallFragment(fragment: TestCallFragment): Fragment

    @Binds
    @IntoMap
    @FragmentKey(GlobitsHomeFragment::class)
    fun bindGlobitsHomeFragment(fragment: GlobitsHomeFragment): Fragment

    @Binds
    @IntoMap
    @FragmentKey(RegistrationLandingFragment::class)
    fun bindRegistrationLandingFragment(fragment: RegistrationLandingFragment): Fragment

    @Binds
    @IntoMap
    @FragmentKey(RegistrationSection0Fragment::class)
    fun bindRegistrationSection0Fragment(fragment: RegistrationSection0Fragment): Fragment

    @Binds
    @IntoMap
    @FragmentKey(RegistrationSection1Fragment::class)
    fun bindRegistrationSection1Fragment(fragment: RegistrationSection1Fragment): Fragment

    @Binds
    @IntoMap
    @FragmentKey(RegistrationSection2Fragment::class)
    fun bindRegistrationSection2Fragment(fragment: RegistrationSection2Fragment): Fragment

    @Binds
    @IntoMap
    @FragmentKey(RegistrationSection3Fragment::class)
    fun bindRegistrationSection3Fragment(fragment: RegistrationSection3Fragment): Fragment

    @Binds
    @IntoMap
    @FragmentKey(RegistrationSection4Fragment::class)
    fun bindRegistrationSection4Fragment(fragment: RegistrationSection4Fragment): Fragment
