...
import im.vector.app.ext.data.ExtModule
...
import im.vector.app.features.home.room.detail.RoomDetailActivityNew
...
interface ScreenComponent {
    ...
    fun inject(activity: GlobitsHomeActivity)
    fun inject(activity: ProfileActivity)
    fun inject(activity: EncounterActivity)
    fun inject(activity: LaboratoryActivity)
    fun inject(activity: PrescriptionActivity)
    fun inject(activity: ChatActivity)
    fun inject(activity: RegistrationActivity)
    fun inject(activity: TestCallActivity)

    fun inject(activity: HomeActivity)
    fun inject(activity: RoomDetailActivity)
    fun inject(activity: RoomDetailActivityNew)
